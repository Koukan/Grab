...
namespace	ShipInfo
{
  ...
  {"Replicator", "player4", "player4", "concentratedPlayer4", false, false, 500,
   GrabPosition::MIDDLE_TOP, 0, GrabPosition::LEFT_BOTTOM_CORNER, 0, GrabPosition::RIGHT_BOTTOM_CORNER, 0, SHIELD, 0, -40, 400},
  {"Obliterator", "player3", "player2", "concentratedPlayer2", true, false, 500,
   GrabPosition::MIDDLE_BOTTOM, 180, GrabPosition::LEFT_BOTTOM_CORNER, 90, GrabPosition::RIGHT_BOTTOM_CORNER, -90, BLACKHOLE, 0, 0, 600},
  {"Conqueror", "player1", "player3", "concentratedPlayer3", false, false, 500,
   GrabPosition::MIDDLE_TOP, 0, GrabPosition::LEFT_BOTTOM_CORNER, 0, GrabPosition::RIGHT_BOTTOM_CORNER, 0, MISSILE, 0, -40, 320},
  {"Voyageer", "player2", "player1", "concentratedPlayer3", true, true, 500,
   GrabPosition::MIDDLE_BOTTOM, 0, GrabPosition::LEFT_TOP_CORNER, 0, GrabPosition::RIGHT_TOP_CORNER, 0, SHIELD, 0, -40, 400},
  {"LadyBird", "player5", "player3", "concentratedPlayer3", true, true, 500,
   GrabPosition::MIDDLE_TOP, 0, GrabPosition::LEFT, 0, GrabPosition::RIGHT, 0, SHIELD, 0, -40, 400},
	};
